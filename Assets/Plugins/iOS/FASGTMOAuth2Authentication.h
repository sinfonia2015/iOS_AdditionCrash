...
#define FASGTMOAuth2Fetcher FASGTMBridgeFetcher
#define FASGTMOAuth2FetcherService FASGTMBridgeFetcherService
#define FASGTMOAuth2FetcherServiceProtocol FASGTMBridgeFetcherServiceProtocol
#define FASGTMOAuth2AssertValidSelector FASGTMBridgeAssertValidSelector
#define FASGTMOAuth2CookieStorage FASGTMBridgeCookieStorage
#define kFASGTMOAuth2FetcherStatusDomain kFASGTMBridgeFetcherStatusDomain
#define kFASGTMOAuth2StatusBadRequest kFASGTMBridgeFetcherStatusBadRequest
...
#ifndef FASGTM_OAUTH2_BEARER
#define FASGTM_OAUTH2_BEARER "Bearer"
#endif
...
extern NSString *const kFASGTMOAuth2ServiceProviderGoogle;

//
// FASGTMOAuth2SignIn constants, included here for use by clients
//
extern NSString *const kFASGTMOAuth2ErrorDomain;

// Error userInfo keys
extern NSString *const kFASGTMOAuth2ErrorMessageKey;
extern NSString *const kFASGTMOAuth2ErrorRequestKey;
extern NSString *const kFASGTMOAuth2ErrorJSONKey;

enum {
  // Error code indicating that the window was prematurely closed
  kFASGTMOAuth2ErrorWindowClosed          = -1000,
  kFASGTMOAuth2ErrorAuthorizationFailed   = -1001,
  kFASGTMOAuth2ErrorTokenExpired          = -1002,
  kFASGTMOAuth2ErrorTokenUnavailable      = -1003,
  kFASGTMOAuth2ErrorUnauthorizableRequest = -1004
};


// Notifications for token fetches
extern NSString *const kFASGTMOAuth2FetchStarted;
extern NSString *const kFASGTMOAuth2FetchStopped;

extern NSString *const kFASGTMOAuth2FetcherKey;
extern NSString *const kFASGTMOAuth2FetchTypeKey;
extern NSString *const kFASGTMOAuth2FetchTypeToken;
extern NSString *const kFASGTMOAuth2FetchTypeRefresh;
extern NSString *const kFASGTMOAuth2FetchTypeAssertion;
extern NSString *const kFASGTMOAuth2FetchTypeUserInfo;

// Token-issuance errors
extern NSString *const kFASGTMOAuth2ErrorKey;
extern NSString *const kFASGTMOAuth2ErrorObjectKey;

extern NSString *const kFASGTMOAuth2ErrorInvalidRequest;
extern NSString *const kFASGTMOAuth2ErrorInvalidClient;
extern NSString *const kFASGTMOAuth2ErrorInvalidGrant;
extern NSString *const kFASGTMOAuth2ErrorUnauthorizedClient;
extern NSString *const kFASGTMOAuth2ErrorUnsupportedGrantType;
extern NSString *const kFASGTMOAuth2ErrorInvalidScope;
...
extern NSString *const kFASGTMOAuth2UserSignedIn;

// Notification for token changes
extern NSString *const kFASGTMOAuth2AccessTokenRefreshed;
extern NSString *const kFASGTMOAuth2RefreshTokenChanged;
extern NSString *const kFASGTMOAuth2AccessTokenRefreshFailed;

// Notification for WebView loading
extern NSString *const kFASGTMOAuth2WebViewStartedLoading;
extern NSString *const kFASGTMOAuth2WebViewStoppedLoading;
extern NSString *const kFASGTMOAuth2WebViewKey;
extern NSString *const kFASGTMOAuth2WebViewStopKindKey;
extern NSString *const kFASGTMOAuth2WebViewFinished;
extern NSString *const kFASGTMOAuth2WebViewFailed;
extern NSString *const kFASGTMOAuth2WebViewCancelled;

// Notification for network loss during html sign-in display
extern NSString *const kFASGTMOAuth2NetworkLost;
extern NSString *const kFASGTMOAuth2NetworkFound;

#ifdef __cplusplus
}
#endif

@interface FASGTMOAuth2Authentication : NSObject <FASGTMFetcherAuthorizationProtocol>  {
 @private
  NSString *clientID_;
  ...
  FASGTMOAuth2Fetcher *refreshFetcher_;
  NSMutableArray *authorizationQueue_;

  id <FASGTMOAuth2FetcherServiceProtocol> fetcherService_; // WEAK
...
// circular retains.
@property (assign) id <FASGTMOAuth2FetcherServiceProtocol> fetcherService; // WEAK

// Alternative JSON parsing class; this should implement the
// FASGTMOAuth2ParserClass informal protocol. If this property is
...
//////////////////////////////////////////////////////////////////////////////
//
// Internal properties and methods for use by FASGTMOAuth2SignIn
//

// Pending fetcher to get a new access token, if any
@property (retain) FASGTMOAuth2Fetcher *refreshFetcher;
