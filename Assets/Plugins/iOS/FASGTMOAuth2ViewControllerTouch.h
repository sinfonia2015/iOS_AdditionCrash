...
extern NSString *const kFASGTMOAuth2KeychainErrorDomain;
...
extern NSString *const kFASGTMOAuth2CookiesWillSwapOut;
extern NSString *const kFASGTMOAuth2CookiesDidSwapIn;

#ifdef __cplusplus
}
#endif

@class FASGTMOAuth2SignIn;
@class FASGTMOAuth2ViewControllerTouch;

typedef void (^FASGTMOAuth2ViewControllerCompletionHandler)(FASGTMOAuth2ViewControllerTouch *viewController, FASGTMOAuth2Authentication *auth, NSError *error);

@interface FASGTMOAuth2ViewControllerTouch : UIViewController<UINavigationControllerDelegate, UIWebViewDelegate> {
 @private
  ...
  FASGTMOAuth2ViewControllerCompletionHandler completionBlock_;
...
// requests
@property (nonatomic, retain, readonly) FASGTMOAuth2Authentication *authentication;

// the underlying object which performs the sign-in networking sequence
@property (nonatomic, retain, readonly) FASGTMOAuth2SignIn *signIn;
...
// To function, FASGTMOAuth2ViewControllerTouch needs a certain amount of access
...
enum {
  kFASGTMOAuth2KeychainErrorBadArguments = -1301,
  kFASGTMOAuth2KeychainErrorNoPassword = -1302
};


@interface FASGTMOAuth2Keychain : NSObject
